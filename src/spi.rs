...
use gpio::{Alternate, AF0, AF1, AF5};
use time::Hertz;
...
impl<PINS> Spi<SPI2, PINS> {
    pub fn spi2<F>(spi: SPI2, pins: PINS, mode: Mode, speed: F, clocks: Clocks) -> Self
    where
        PINS: Pins<SPI2>,
        F: Into<Hertz>,
    {
    ...
    pub fn release(self) -> (SPI2, PINS) {
        (self.spi, self.pins)
    }
}

impl<PINS> ::hal::spi::FullDuplex<u8> for Spi<SPI2, PINS> {
    type Error = Error;
...
impl<PINS> ::hal::blocking::spi::transfer::Default<u8> for Spi<SPI2, PINS> {}
impl<PINS> ::hal::blocking::spi::write::Default<u8> for Spi<SPI2, PINS> {}
