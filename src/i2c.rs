...
impl Pins<I2C2> for (PB10<Alternate<AF1>>, PB11<Alternate<AF1>>) {}
impl Pins<I2C2> for (PB13<Alternate<AF5>>, PB14<Alternate<AF5>>) {}
...
impl<PINS> I2c<I2C2, PINS> {
    pub fn i2c2(i2c: I2C2, pins: PINS, speed: KiloHertz) -> Self
    where
        PINS: Pins<I2C2>,
    {
        // NOTE(unsafe) This executes only during initialisation
